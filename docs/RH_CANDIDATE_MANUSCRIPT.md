...
Under the same trace-closure assumption, Green and strict production give the
same quantity as \(E_-+E_+>0\). Thus

$$
0=M_-(0)-M_+(0)=E_-+E_+>0,
$$

conditionally a contradiction for \(0<\operatorname{Im}\alpha<1/2\).
