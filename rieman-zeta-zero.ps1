...
Write-Host "============================================================"
Write-Host "Riemann Zeta Zero Finding Suite — proprietary source code"
Write-Host "Copyright © 2026 Carmen Wrede and Lino Casu"
Write-Host ""
Write-Host "No copying, modification, redistribution, sublicensing, or commercial use"
Write-Host "is granted by this launcher. See LICENSE-CODE.md. Manuscript and"
Write-Host "non-executable documentation have separate terms in LICENSE-DOCUMENTATION."
